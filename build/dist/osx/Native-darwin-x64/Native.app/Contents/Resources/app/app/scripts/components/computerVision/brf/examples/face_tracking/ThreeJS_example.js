(function exampleCode() {
	...
	function loadModels() {
		...
		if(t3d) {
			...
			t3d.removeAll();
			t3d.loadOcclusionHead("libraries/BRF/assets/brfv4_occlusion_head.json", numFacesToTrack);
			t3d.loadModel("libraries/BRF/assets/brfv4_model.json", numFacesToTrack);
		}
	}
