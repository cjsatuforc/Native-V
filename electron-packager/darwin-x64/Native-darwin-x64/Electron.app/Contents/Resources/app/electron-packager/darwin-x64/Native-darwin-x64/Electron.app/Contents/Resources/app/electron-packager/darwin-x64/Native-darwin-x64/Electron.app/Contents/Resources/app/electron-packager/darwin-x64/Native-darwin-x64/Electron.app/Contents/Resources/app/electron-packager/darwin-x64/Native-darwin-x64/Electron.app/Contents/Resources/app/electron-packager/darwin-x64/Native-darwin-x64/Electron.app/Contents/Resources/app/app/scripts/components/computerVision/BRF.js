...
function startCamera() {
    ...
    navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia({video: {width: 640, height: 480, frameRate: 30}})
...
function waitForSDK() {
    ...
    if(brfv4 === null) {
        brfv4 = {locateFile: function() { return "/scripts/components/computerVision/brf/BRFv4_JS_trial.js.mem" }};
        initializeBRF(brfv4);
    }
